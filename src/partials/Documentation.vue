  ...
  <section>
    <div class="max-w-3xl mx-auto px-4 sm:px-6">
      <div class="pb-12 md:pb-20">
        ...
        <!-- Section header -->
        <h3 class="h4 mb-8">Documentation to help</h3>
        ...
        <div class="-my-3" data-aos-id-career>
          ...
          <div class="py-3" data-aos="fade-up" data-aos-anchor="[data-aos-id-career]">
            <div class="pb-6 border-b border-gray-800">
              ...
              <div class="text-lg text-gray-400 mb-3">
                How and why to deploy your own test network node and become a member. How to get tokens to test your own transactions
              </div>
              <div class="text-gray-400 flex flex-wrap items-center">
                <div class="inline-flex items-center">
                  <svg class="mr-2 shrink-0" vidth="14" height="17" viewBox="0 0 14 17" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span>Web3 Amassadors</span>
                </div>
                <span class="text-gray-700 mx-3"> - </span>
                <div class="inline-flex items-center">

                  <svg class="mr-2 shrink-0" vidth="14" height="16" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    viewBox="0 0 299.998 299.998" style="enable-background:new 0 0 299.998 299.998;" xml:space="preserve">
                      <path class="fill-current text-gray-300" d="M149.997,0C67.157,0,0.001,67.158,0.001,149.995s67.156,150.003,149.995,150.003s150-67.163,150-150.003
          ...
          <div class="py-3" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-career]">
            <div class="pb-6 border-b border-gray-800">
              ...
              <div class="text-lg text-gray-400 mb-3">
                How and why to become a network delegate. How to control your own account after enabling forging mode
              </div>
              <div class="text-gray-400 flex flex-wrap items-center">
                <div class="inline-flex items-center">
                  <svg class="mr-2 shrink-0" vidth="14" height="17" viewBox="0 0 14 17" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="py-3" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-career]">
            <div class="pb-6 border-b border-gray-800">
              ...
              <div class="text-lg text-gray-400 mb-3">
                Description for developers how to interact with the test network without having to deploy their own network node
              </div>
              <div class="text-gray-400 flex flex-wrap items-center">
                <div class="inline-flex items-center">
                  <svg class="mr-2 shrink-0" vidth="14" height="17" viewBox="0 0 14 17" xmlns="http://www.w3.org/2000/svg">
